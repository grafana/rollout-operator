...
func (c *Cache) AddOrUpdateRaw(obj *unstructured.Unstructured) (bool, error) {
...
func (c *Cache) addOrUpdate(pdb *Config) bool {
	c.lock.Lock()
	defer c.lock.Unlock()
...
func (c *Cache) Delete(generation int64, name string) bool {
	c.lock.Lock()
	defer c.lock.Unlock()
